    ...
    config = function()
      ...
      require('lspconfig').yamlls.setup {
        settings = {
          yaml = {
            schemas = {
              ['https://raw.githubusercontent.com/SchemaStore/schemastore/master/src/schemas/json/springboot.json'] = 'application.yml',
            },
          },
        },
      }
          ...
          jdtls = function()
            require('java').setup {
              ...
              format = {
                enabled = true,
                settings = {
                  url = 'file://' .. vim.fn.expand '~/.config/nvim/eclipse-code-formatter.xml',
                },
              },
              configuration = {
                runtimes = {
